...
"agree_pic":"../picture/event/cave/skull_king_agree.png","agree_message":"怎麼有人喜歡這樣玩啊\n以更快的速度逃離你的視線範圍","reject_pic":"../picture/monster/cave/event/skull_king.png","reject_message":"算你倒楣，我就愛這樣玩"},
{"pic":"../picture/event/cave/water.png","narrate":"前方有一杯水，是山洞滴水積成的嗎?","agree":"正好口渴，喝了","reject":"用打火機點燃它試試","a_effect":"命中和迴避降低","r_effect":"繼續前行",
"agree_pic":"../picture/event/cave/water_agree.png","agree_message":"這是......喉嚨快要灼傷了","reject_pic":"../picture/event/cave/water_reject.png","reject_message":"竟然可以燃燒，感覺有問題"},
];
let luck_event=[
...
//用來判斷是遇到什麼行動
function Action(){
    let dice_result = Math.floor(Math.random()*99)+1;
    ...
    switch(true){
        case dice_result <= 50:
            //遭遇一般事件
            location.href='event_forest.html';
            console.log("事件");
            break;
        case dice_result <= 99:
            //遭遇戰鬥
            location.href='battle_forest.html';
            console.log("遇到戰鬥");
            break;
    }
}
